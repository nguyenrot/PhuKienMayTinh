...
@section('title')
    <title>Cập nhập hãng phụ kiện</title>
@endsection
@section('link_css')
...
@section('container-fluid')
    <div class="container-fluid">
        <h1 class="h3 mb-4 font-weight-bold text-gray-800 text-primary">Cập nhập hãng phụ kiện</h1>
            ...
            <div class="card-body">
                <form action="{{route('menu.update',['id'=>$menu->id])}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control" placeholder="Nhập tên hãng phụ kiện" value="{{$menu->name}}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Mô tả</label>
                        <textarea name="description" id="" rows="5" class="form-control" placeholder="Mô tả ">{{$menu->description}}</textarea>
                    </div>
